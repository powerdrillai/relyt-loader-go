...
func (p *BulkProcessor) UpdateByQueryWithContextV2(ctx context.Context, options *UpdateByQueryOptions, args ...interface{}) (int64, error) {
	p.mutex.RLock()
	if p.isShutdown {
		p.mutex.RUnlock()
	...
	processedUpdates := make(map[string]interface{}, len(options.Updates))
